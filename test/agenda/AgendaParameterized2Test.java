...
public class AgendaParameterized2Test {
    ...
    public AgendaParameterized2Test(Agenda aagenda, Date adate1, Date adate2, String anomEvenement) throws ErreurEvenement {
        agenda = aagenda;
        date1 = adate1;
        date2 = adate2;
